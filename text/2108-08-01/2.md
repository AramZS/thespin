...
# Primaries Five Months Away, Pollsters Needed

###### The Spin Will Pay for Poll Takers, Talkers, Data Analysts 

headerEnd

CAMPAIGNS MOVE INTO FINAL MONTHS, PRIMARY WINNERS LESS SURE THAN EVER

While we all long for the halcyon days of yore when there were full years of zero campaigning in which the presidential elections were suspended during the Sink, there's no getting around the new schedule for primaries and finally the Presidential election. 

The Spin needs on the ground monitors, pollsters, data minors and analysts to help figure out what is going on with The Enclave's electorate, one of the largest contributors of votes in the country. Our early monitoring, polls, and data are not just informative, they help us show the election preceding in order and as expected. With open data and tight integrations with electioneering systems to monitor software we are a vital part of the democratic system. 

As is normal for this time, we have a seasonal need for experts and real humans on the front line, slapping shoe leather and giving and collecting survey results.

If you are an expert, you can apply for a exception from your employer to help with this important task. 

The Spin is glad to join with other media organizations to start the process of polling and measurement that will help us understand vital shifts in sentiment and help validate the results.
